...
- genes from DNA: AGCT
- genes are instructions and blueprints for life

2. Genomics
- study of genes
- more complex organisms have more complex genes
- studying complex organisms needs a lot of storage

3. Sequencing
- reading genes from cells is sequencing
- replications(coverage) \& fragmentation of DNA to read
- store the many fragments

4. Human Genome Project
- finished in 2003, project wanted to read the entire human genome
- didn't have the tools at the time
- big cost, many institutions, 10 years

5. Next Generation Sequencing
- new technology to read sequences faster
- reading faster -> more reads -> more data

6. Growing problem of storage
- moore's law make faster processing power and better storage
- but moore's law is too slow for genomic data increase
- each has 60x coverage, around 200gb each
- NGS, More genomic researches, more files needed to be saved and transferred


TECH
7. Database
- store data with tech
...
- Centralized
- Distributed
- use Distributed becuz x

11. Application Architecture
- Client Server
- P2P
- Hybrid
- Use Hybrid because X
...
SYSTEM
19. Network
- five levels, but needs Level 4 and 5 only
20. Summary
- system is this
- distributed
- community assisted
...
21. User-System
- user talks to system (via master)

22. Master-Data
- master is the main interface
- data is what stores info

23. Internal Node Interface
- frontend talks to backend
- backend talks to other backend via APIs

24. Internal Node Structure
- front end
- back end
- database
...
COMPARISONS
26. Speed Comparisons
- simple time complexity chart
- faster si caDDS ofc

27. Pros and Cons Comparisons
-caDDS is scalable, easy for community, has docu hehe
-NCBI is one, very specific features, 
...
% CID PROGRESS FOR JUNE 4 HAS A LOT OF ROUGH IDEAS
% CID PROGRESS ENDS HEREE FOR JUNE 4 2020
