...
\begin{frame}{Genomics}
  ...
  \begin{itemize}   
    \item study of genes
    \item more complex organisms have more complex genes
    \item studying complex organisms needs a lot of storage
  \end{itemize}
\end{frame}
...
\begin{frame}{Sequencing}
  \begin{itemize}   
    ...
    \item replications(coverage) \& fragmentation of DNA to read
    \item store the many fragments
  \end{itemize}
\end{frame}
...
\begin{frame}{Human Genome Project}
  \begin{itemize}   
    ...
    \item didn't have the tools at the time
